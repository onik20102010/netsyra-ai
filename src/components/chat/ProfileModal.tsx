...
export default function ProfileModal({
  open, onClose, userName, userGoal, userInstructions, onSave,
}: ProfileModalProps) {
  ...
  useEffect(() => {
    ...
    const fetchUsage = async () => {
      ...
      const modelLabels: Record<string, string> = {
        fast: "N Fast", plus: "N Plus", pro: "N Pro",
        live: "N Live", code: "N Code",
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-1 bg-gray-100 rounded-lg p-0.5">
                  ...
                  <button
                    ...
                    className={`px-3 py-1 rounded-md text-xs font-medium transition ${
                      activeTab === "usage" ? "bg-white text-gray-900 shadow-sm" : "text-gray-500"
                    }`}
                  >
                    Usage
                  </button>
            ...
            {activeTab === "profile" ? (
              <>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mb-2">Tell the AI how to respond (e.g. "Always reply in Spanish").</p>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600 flex items-center gap-2"><Sun className="w-4 h-4 text-gray-400" /> Theme</span>
                    <span className="text-sm font-medium text-gray-900 bg-gray-100 px-3 py-1 rounded-full">Light</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600 flex items-center gap-2"><Globe className="w-4 h-4 text-gray-400" /> Language</span>
                ...
                <button onClick={handleSave} disabled={saving}
                  ...
                  {saving ? (
                    ...
                    <span className="flex items-center justify-center gap-2"><Check className="w-4 h-4" /> Save Changes</span>
                  )}
                </button>
              </>
            ) : (
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-4 rounded-xl bg-indigo-50 border border-indigo-100">
                    ...
                    <p className="text-2xl font-bold text-indigo-700">{usage?.messagesToday || 0}</p>
                  ...
                  <div className="p-4 rounded-xl bg-purple-50 border border-purple-100">
                    ...
                    <p className="text-2xl font-bold text-purple-700">{usage?.totalMessages || 0}</p>
                      ...
                      {usage.modelUsage.map((m, i) => (
                        <div key={i} className="flex items-center justify-between p-3 rounded-xl bg-gray-50 border border-gray-100">
                          ...
                          <div className="text-right">
                            <p className="text-sm font-semibold text-gray-900">{m.tokens.toLocaleString()}</p>
